...
void addSportActivities();

void viewSportActivities();

void editSportActivities();

void removeSportActivities();
...

{
...

    {
...

        {
            ...
            printf("\tNOTE(anything else):");

            gets(e.note);

            fwrite ( &e, sizeof ( e ), 1, fp ) ;

            printf("\nYOUR ACTIVITIES IS ADDED...\n");

        }

        printf ( "\n\tADD ANOTHER ACTIVITIES...(Y/N) " ) ;
...

{
    ...
    printf("\t\t* THIS IS ACTIVITIES YOU HAVE DONE: ");
...

    {
        ...
        case 1:
            ...
            while ( fread ( &info, sizeof ( info ), 1, fpte ) == 1 )

            {
                ...
                printf("\nMEETING WITH: %s",info.sportName);

                printf("\nMEETING AT: %s",info.place);
...

{
...

    {
        ...
        printf("\n\tENTER THE DATE OF ACTIVITIES YOU WANT TO EDIT:[yyyy-mm-dd]:");
...

        {
...

            {
                ...
                fseek(fpte,-sizeof(info),SEEK_CUR);

                fwrite(&info,sizeof(info),1,fpte);

                fseek(fpte,-sizeof(info),SEEK_CUR);

                fread(&info,sizeof(info),1,fpte);
