/*
Write a program that asks user to enter name of a file. The program opens the file in text mode and
calculates frequency of first letters of all words. Only words beginning with a letter are counted.
Finally, the program prints a list of five most frequent first characters and their frequencies
*/
...
#include <time.h>
#define LARGEST 1
#define SECOND_LARGEST 2
#define THIRD_LARGEST 3
#define FOURTH_LARGEST 4
#define FIFTH_LARGEST 5
